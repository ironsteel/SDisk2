...
$EndDescr
$Comp
L SDisk2:ATmega328P-PU-MCU_Microchip_ATmega U2
U 1 1 5FF887A0
P 4000 3000
F 0 "U2" H 4050 3150 50  0000 R CNN
F 1 "ATmega328P-PU" H 4300 3050 50  0000 R CNN
...
$EndComp
$Comp
L SDisk2:LM317_SOT-223-Regulator_Linear U3
U 1 1 5FF8F222
P 4700 6000
...
$EndComp
$Comp
L SDisk2:Crystal_Small-Device Y1
U 1 1 5FF8FBDF
P 6100 2450
...
Wire Wire Line
	7650 3400 7650 3450
$Comp
L SDisk2:GND-power #PWR0101
U 1 1 6017C6FC
P 7650 3450
F 0 "#PWR0101" H 7650 3200 50  0001 C CNN
F 1 "GND-power" H 7750 3450 50  0000 C CNN
...
Wire Wire Line
	6450 2550 7550 2550
$Comp
L SDisk2:GND-power #PWR0103
U 1 1 6018C954
P 7550 2550
F 0 "#PWR0103" H 7550 2300 50  0001 C CNN
F 1 "GND-power" H 7555 2377 50  0000 C CNN
...
3.3V
$Comp
L SDisk2:GND-power #PWR0104
U 1 1 6019EED8
P 4700 7000
F 0 "#PWR0104" H 4700 6750 50  0001 C CNN
F 1 "GND-power" H 4705 6827 50  0000 C CNN
...
Wire Wire Line
	4700 6800 4700 7000
$Comp
L SDisk2:+5V-power #PWR0105
U 1 1 601A2926
P 3000 5800
F 0 "#PWR0105" H 3000 5650 50  0001 C CNN
F 1 "+5V-power" H 3015 5973 50  0000 C CNN
...
Wire Wire Line
	3000 5800 3000 5950
$Comp
L SDisk2:GND-power #PWR0106
U 1 1 601A3FC3
P 3000 7000
F 0 "#PWR0106" H 3000 6750 50  0001 C CNN
F 1 "GND-power" H 3005 6827 50  0000 C CNN
...
Wire Wire Line
	7900 2200 8150 2200
$Comp
L SDisk2:GND-power #PWR0107
U 1 1 601ABC4A
P 8150 2200
F 0 "#PWR0107" H 8150 1950 50  0001 C CNN
F 1 "GND-power" H 8155 2027 50  0000 C CNN
...
Wire Wire Line
	1400 6050 1800 6050
$Comp
L SDisk2:+5V-power #PWR0108
U 1 1 601C6CEA
P 1400 5700
F 0 "#PWR0108" H 1400 5550 50  0001 C CNN
F 1 "+5V-power" H 1415 5873 50  0000 C CNN
...
Wire Wire Line
	7650 3800 9100 3800
$Comp
L SDisk2:Conn_02x10_Odd_Even-Connector_Generic J2
U 1 1 60233B65
P 10450 1700
...
$EndComp
$Comp
L SDisk2:+5V-power #PWR0110
U 1 1 60259CCF
P 8350 2100
F 0 "#PWR0110" H 8350 1950 50  0001 C CNN
F 1 "+5V-power" H 8365 2273 50  0000 C CNN
...
$Comp
L SDisk2:GND-power #PWR0111
U 1 1 60288041
P 10900 2200
F 0 "#PWR0111" H 10900 1950 50  0001 C CNN
F 1 "GND-power" H 10905 2027 50  0000 C CNN
...
Wire Wire Line
	4100 1200 4100 1000
$Comp
L SDisk2:+5V-power #PWR0112
U 1 1 602B34E0
P 4100 1000
F 0 "#PWR0112" H 4100 850 50  0001 C CNN
F 1 "+5V-power" H 4115 1173 50  0000 C CNN
...
Wire Wire Line
	3300 1800 3300 1000
$Comp
L SDisk2:+5V-power #PWR0113
U 1 1 602B8840
P 3300 1000
F 0 "#PWR0113" H 3300 850 50  0001 C CNN
F 1 "+5V-power" H 3315 1173 50  0000 C CNN
...
Wire Wire Line
	4000 4500 4000 4600
$Comp
L SDisk2:GND-power #PWR0114
U 1 1 602BD271
P 4000 4600
F 0 "#PWR0114" H 4000 4350 50  0001 C CNN
F 1 "GND-power" H 4005 4427 50  0000 C CNN
...
$Comp
L SDisk2:GND-power #PWR0115
U 1 1 6030A9CE
P 3350 2650
F 0 "#PWR0115" H 3350 2400 50  0001 C CNN
F 1 "GND-power" H 3355 2477 50  0000 C CNN
...
Wire Wire Line
	4300 5700 4300 6000
$Comp
L SDisk2:+5V-power #PWR0116
U 1 1 601A119E
P 4300 5700
F 0 "#PWR0116" H 4300 5550 50  0001 C CNN
F 1 "+5V-power" H 4315 5873 50  0000 C CNN
...
Wire Wire Line
	8800 1800 8800 950 
$Comp
L SDisk2:+5V-power #PWR0117
U 1 1 60362BF2
P 8800 950
F 0 "#PWR0117" H 8800 800 50  0001 C CNN
F 1 "+5V-power" H 8815 1123 50  0000 C CNN
...
Wire Wire Line
	5850 5300 5850 5000
$Comp
L SDisk2:+5V-power #PWR0118
U 1 1 60491413
P 5850 5000
F 0 "#PWR0118" H 5850 4850 50  0001 C CNN
F 1 "+5V-power" H 5865 5173 50  0000 C CNN
...
Wire Wire Line
	700  2100 700  1850
$Comp
L SDisk2:+5V-power #PWR0119
U 1 1 604F8BA1
P 700 1850
F 0 "#PWR0119" H 700 1700 50  0001 C CNN
F 1 "+5V-power" H 715 2023 50  0000 C CNN
...
Wire Wire Line
	6900 4750 6900 4700
$Comp
L SDisk2:+5V-power #PWR0102
U 1 1 60718A60
P 6900 4700
F 0 "#PWR0102" H 6900 4550 50  0001 C CNN
F 1 "+5V-power" H 6915 4873 50  0000 C CNN
...
$EndComp
$Comp
L SDisk2:+5V-power #PWR0121
U 1 1 60766FBF
P 7150 5450
F 0 "#PWR0121" H 7150 5300 50  0001 C CNN
F 1 "+5V-power" H 7165 5623 50  0000 C CNN
...
Wire Wire Line
	1750 3600 2200 3600
$Comp
L SDisk2:GND-power #PWR0122
U 1 1 6095F16A
P 2150 5750
F 0 "#PWR0122" H 2150 5500 50  0001 C CNN
F 1 "GND-power" H 2155 5577 50  0000 C CNN
...
Wire Wire Line
	2400 3750 2400 4700
$Comp
L SDisk2:+5V-power #PWR0123
U 1 1 6093C33B
P 2400 3750
F 0 "#PWR0123" H 2400 3600 50  0001 C CNN
F 1 "+5V-power" H 2415 3923 50  0000 C CNN
...
Wire Wire Line
	1750 5200 2400 5200
$Comp
L SDisk2:GND-power #PWR0124
U 1 1 6091ACDE
P 750 5200
F 0 "#PWR0124" H 750 4950 50  0001 C CNN
F 1 "GND-power" H 755 5027 50  0000 C CNN
...
$EndComp
$Comp
L SDisk2:GND-power #PWR0125
U 1 1 607E0E42
P 9450 6050
F 0 "#PWR0125" H 9450 5800 50  0001 C CNN
F 1 "GND-power" H 9455 5877 50  0000 C CNN
...
$Comp
L SDisk2:+5V-power #PWR0126
U 1 1 60B972FB
P 9250 4000
F 0 "#PWR0126" H 9250 3850 50  0001 C CNN
F 1 "+5V-power" H 9265 4173 50  0000 C CNN
...
$Comp
L SDisk2:GND-power #PWR0127
U 1 1 60BA5E39
P 10450 5050
F 0 "#PWR0127" H 10450 4800 50  0001 C CNN
F 1 "GND-power" H 10455 4877 50  0000 C CNN
...
Wire Wire Line
	900  2200 900  2950
$Comp
L SDisk2:GND-power #PWR0128
U 1 1 5FFFE7B3
P 900 2950
F 0 "#PWR0128" H 900 2700 50  0001 C CNN
F 1 "GND-power" H 905 2777 50  0000 C CNN
...
$EndComp
$Comp
L SDisk2:+5V-power #PWR0120
U 1 1 60782252
P 7400 6050
F 0 "#PWR0120" H 7400 5900 50  0001 C CNN
F 1 "+5V-power" H 7415 6223 50  0000 C CNN
...
$EndComp
$Comp
L SDisk2:GND-power #PWR0109
U 1 1 6017E609
P 7650 4250
F 0 "#PWR0109" H 7650 4000 50  0001 C CNN
F 1 "GND-power" H 7655 4077 50  0000 C CNN
